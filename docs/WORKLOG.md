...
- Repository checkpoint: 104 canonical `fulltext/en.json` + `fulltext/tr.json` pairs remain alongside 140 legacy `en-archive.json` files; `current.json` and `saudi-en.json` are absent.
