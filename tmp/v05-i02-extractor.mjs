...
const issueKey = process.argv[2] || "5-2";
...
if (!issueConfig) throw new Error(`Unknown issue ${issueKey}. Use 5-2, 5-3, 5-4, 7-1, 7-2, 7-3, or 7-4.`);
...
const candidateRoot = join(root, "tmp/v05-i02-candidates");
...
rmSync(temp, { recursive: true });
console.log("Generated v05-i02 prose candidates for " + records.length + " records.");
