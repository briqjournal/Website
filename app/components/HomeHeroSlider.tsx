  ...
  tr: [
    {
      ...
      secondaryHref: "/tr/guncel-sayi#pdf-viewer",
    ...
    },
    {
      ...
      href: "/tr/arsiv/cilt-7-sayi-3",
      action: "Sayıyı incele",
      secondaryHref: "/tr/arsiv",
    ...
    },
    {
      ...
      href: "/tr/makale-cagrilari/transatlantik-iliskilerin-yeniden-yapilanmasi",
      action: "Çağrıyı incele",
      secondaryHref: "/tr/yazarlar/yazim-kurallari",
    ...
    },
    {
      ...
      href: "/tr/makale-cagrilari/yapay-zeka-uretici-gucler-ortak-refah",
      action: "Çağrıyı incele",
      secondaryHref: "/tr/yazarlar/yazim-kurallari",
      secondary: "Yazım kuralları",
  ...
  en: [
    {
      ...
      image: "/assets/archive/covers/cilt-7-sayi-4-en-v3.jpg",
...
export function HomeHeroSlider({ locale = "tr" }: { locale?: Locale }) {
  ...
  return (
    ...
    >
      ...
      <button type="button" className="hero-nav hero-nav-next" onClick={next} aria-label={locale === "en" ? "Next slide" : "Sonraki slayt"}><svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg></button>
