const themes: Record<string, { tr: string; en: string }> = {
  ...
  "2-1": { tr: "Deniz İpek Yolu’nda ‘Mavi Vatan’ Buluşması", en: "Reclaiming the 'Blue Homeland' Through the Maritime Silkroad." },
  ...
  "3-1": { tr: "Ortak Kader Ortak Gelecek", en: "Common Destiny Shared Future" },
