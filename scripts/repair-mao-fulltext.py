...
sections = [
    {"id": "en-section-1", "title": "Introduction", "paragraphs": [
        ...
        para((77, 82)), para((94, 102)), para((103, 111)), para((112, 124)), para((125, 136), (140, 154)),
    ]},
    {"id": "en-section-2", "title": "Methodology", "paragraphs": [para((157, 164))]},
    {"id": "en-section-3", "title": "Sources of Mao’s Dialectical Thought", "paragraphs": [
        para((175, 193)), para((194, 203), (206, 227)), para((228, 233), (239, 240)), para((241, 245)),
        para((246, 257)), para((258, 264)), para((269, 282)), para((291, 297), (300, 304)), para((305, 323)),
        para((324, 347)), para((348, 367)), para((377, 386)), para((387, 395)), para((396, 402), (405, 410)),
    ]},
    {"id": "en-section-4", "title": "The Fundamental Principles of Dialectics in Mao", "paragraphs": [
        para((413, 422)), para((423, 432), (436, 440)), para((441, 465)), para((474, 479)),
        para((490, 498), (501, 523)), para((524, 528)), para((529, 532), (539, 562)), para((567, 578)),
        para((579, 587)), para((588, 597)), para((600, 612)), para((613, 629)), para((630, 632), (638, 664)),
        para((669, 699), (701, 704)), para((720, 730)), para((737, 755), (757, 766)),
        para((767, 771), (776, 779)), para((791, 802), (805, 813)), para((814, 836), (840, 841)),
        para((842, 850)), para((851, 858)), para((859, 874)), para((875, 886)), para((887, 893), (898, 905)),
    ]},
    {"id": "en-section-5", "title": "Conclusion", "paragraphs": [
        para((908, 912)), para((913, 921)), para((922, 926), (929, 932)), para((933, 946)),
        para((947, 960)), para((964, 973)),
    ]},
]
...
references = copy.deepcopy(CURRENT["en"]["references"])
for reference in references:
    reference["text"] = reference["text"].replace("https://doi.org/ ", "https://doi.org/")
...
assert any("10.4312/as.2019.7.1.55-73" in reference["text"] for reference in references)
